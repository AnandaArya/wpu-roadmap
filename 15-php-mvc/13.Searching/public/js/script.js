...
$(function(){
    ...
    $('.tampilModalUbah').on('click', function() {
        ...
        $('.modal-body form').attr('action', 'http://localhost/belajarcoding/10)phpmvc/13.Searching/public/mahasiswa/ubah')

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/belajarcoding/10)phpmvc/13.Searching/public/mahasiswa/getubah',
